 ...
 */
const f=globalThis,m=f.ShadowRoot&&(void 0===f.ShadyCSS||f.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,g=Symbol(),y=new WeakMap;let v=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==g)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(m&&void 0===e){const i=void 0!==t&&1===t.length;i&&(e=y.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&y.set(t,e))}return e}toString(){return this.cssText}};const b=e=>new v("string"==typeof e?e:e+"",void 0,g),w=(e,...t)=>{const i=1===e.length?e[0]:t.reduce(((t,i,r)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[r+1]),e[0]);return new v(i,e,g)},_=m?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return b(t)})(e):e
/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}function Ee(e){return xe({...e,state:!0,attribute:!1})}const Ce="title",Se="weather_device_id",Ae="summary_weather_entity_id",Te="show_current_temp",Ne="current_temp_entity_id",ze="show_feels_like_temp",Ue="feels_like_temp_entity_id",Pe="show_weather_icon",Me="weather_icon_entity_id",Oe="use_ha_weather_icons",De="show_time",Fe="time_entity_id",Le="show_date",Re="date_entity_id",Ge="show_now_later_temps",Ie="now_later_now_temp_entity_id",He="now_later_now_label_entity_id",We="now_later_later_temp_entity_id",Be="now_later_later_label_entity_id",je="show_warning_count",Ve="warning_count_entity_id",qe="hide_warning_count_if_zero",Ze="show_rain_summary",Je="rain_summary_entity_id",Ke="show_forecast_summary",Ye="forecast_summary_entity_id",Xe="show_hourly_forecast",Qe="show_daily_forecast",et={type:"custom:bom-weather-card",index:void 0,view_index:void 0,[Ce]:void 0,[Se]:void 0,[Ae]:void 0,[Te]:!0,[Ne]:void 0,[ze]:!0,[Ue]:void 0,[Pe]:!0,[Me]:void 0,[Oe]:void 0,[De]:void 0,[Fe]:void 0,[Le]:void 0,[Re]:void 0,[Ge]:!0,[Ie]:void 0,[He]:void 0,[We]:void 0,[Be]:void 0,[je]:!0,[Ve]:void 0,[qe]:void 0,[Ze]:!0,[Je]:void 0,[Ke]:!0,[Ye]:void 0,[Xe]:!0,[Qe]:!0},tt={EN:"en",EN_GB:"en_gb"},it=tt.EN,rt="clear-night",st="cloudy",at="exceptional",nt="fog",ot="hail",lt="lightning-rainy",dt="lightning",ct="partlycloudy",ht="partlycloudy-night",pt="mostly-sunny",ut="pouring",ft="rainy",mt="snowy-rainy",gt="snowy",yt="sunny",vt="windy-variant",bt="windy",wt={[yt]:"clear",[rt]:"clear night",[ct]:"partially-cloudy",[ht]:"partially-cloudy night",[pt]:"partially-cloudy",[st]:"partially-cloudy",[dt]:"stormy",[lt]:"stormy",[ut]:"clear",[ft]:"clear",[gt]:"clear",[mt]:"clear",[bt]:"clear",[vt]:"clear",[nt]:"clear",[ot]:"clear",[at]:"clear"},_t=[Ae,Ne,Ue,Me,Fe,Re,Ie,He,We,Be,Ve,Je,Ye],$t={[Ae]:{idPattern:{parentDeviceConfigProp:Se,pattern:"weather.%device_name%"}},[Ne]:{attributePattern:{parentCardEntity:Ae,attribute:"temperature"}},[Ue]:{},[Me]:{idPattern:{parentDeviceConfigProp:Se,pattern:"weather.%device_name%"}},[Fe]:{idPattern:{parentDeviceConfigProp:void 0,pattern:"sensor.time"}},[Re]:{idPattern:{parentDeviceConfigProp:void 0,pattern:"sensor.date"}},[Ie]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_now_temp_now"}},[He]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_now_now_label"}},[We]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_now_temp_later"}},[Be]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_now_later_label"}},[Ve]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_warnings"}},[Je]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_rain_amount_range_0"}},[Ye]:{idPattern:{parentDeviceConfigProp:Se,pattern:"sensor.%device_name%_short_text_0"}}};async function kt(e){try{return await e.callWS({type:"config/device_registry/list"})}catch(e){return o.error("Error fetching devices",e),[]}}async function xt(e,t){try{return await e.callWS({type:"config/entity_registry/list",domain:t?.domain,area_id:t?.area_id})}catch(e){return o.error("Error fetching entities",e),[]}}const Et=async(e,t)=>{const i={};for(const e of _t)i[e]={entity_id:t[e],attribute:void 0,is_inferred:!1};if(!e)return i;const r=await kt(e),s=await xt(e);let a=100,n=!0;for(;n&&a>0;){n=!1,a--;for(const e of _t)if(!i[e].entity_id){const a=$t[e];if(a?.idPattern){let o=a.idPattern.pattern;const l=a.idPattern.parentDeviceConfigProp;let d;if(l&&(d=r.find((e=>e.id===t[l])),d&&d.name)){const e=d.name.toLowerCase().replace(" ","_");o=o.replace("%device_name%",e)}s.find((e=>e.entity_id===o))&&(n=!0,i[e]={entity_id:o,attribute:void 0,is_inferred:!0})}else if(a?.attributePattern){const t=i[a.attributePattern.parentCardEntity];t?.entity_id&&(n=!0,i[e]={entity_id:t.entity_id,attribute:a.attributePattern.attribute,is_inferred:!0})}}}return i},Ct=(e,t)=>{if(!e||!t?.entity_id)return;const i=e.states[t.entity_id];return i?t.attribute?i.attributes[t.attribute]:i.state:void 0},St=(e,t)=>{const i=Ct(e,t);if(void 0!==i){if("number"==typeof i)return i;if("string"==typeof i)try{return parseFloat(i)}catch{return}}},At=(e,t)=>{const i=Ct(e,t);if(void 0!==i)return"string"==typeof i?i:"number"==typeof i?i.toString():void 0},Tt=(e,t,i,r)=>{const s=Array.isArray(i)?i:[i];for(const t of s)if(!e[t])return!1;return!!t[r]?.entity_id};var Nt={version:"Version",title:"BOM Weather Card",description:"Display weather information in the style of the BOM (Bureau of Meteorology) Australia app."},zt={feelsLike:"Feels like",noRain:"No Rain",rain:"Rain"},Ut={currentTemperatureEntity:"Current Temperature Entity",dailyForecast:"Daily Forecast",dateEntity:"Date Entity",feelsLikeTemperatureEntity:"Feels Like Temperature Entity",forecastSummaryEntity:"Forecast Summary Entity",hideWarningCountIfZero:"Hide Warning Count If Zero",hourlyForecast:"Hourly Forecast",laterLabelEntity:"Later Label Entity",laterTempEntity:"Later Temp Entity",nowLabelEntity:"Now Label Entity",nowTempEntity:"Now Temp Entity",optional:"Optional",rainSummaryEntity:"Rain Summary Entity",required:"Required",showCurrentTemperature:"Show Current Temperature",showDailyForecast:"Show Daily Forecast",showDate:"Show Date",showFeelsLikeTemperature:"Show Feels Like Temperature",showForecastSummary:"Show Forecast Summary",showHourlyForecast:"Show Hourly Forecast",showNowLaterTemps:"Show Now/Later Temperatures",showRainSummary:"Show Rain Summary",showTime:"Show Time",showWarningCount:"Show Warning Count",showWeatherIcon:"Show Weather Icon",summary:"Summary",summaryWeatherEntity:"Summary Weather Entity",timeEntity:"Time Entity",title:"Title",useDefaultHaWeatherIcons:"Use Default HA Weather Icons",warningsCountEntity:"Warnings Count Entity",weatherDevice:"Weather Device",weatherIconEntity:"Weather Icon Entity"},Pt={invalidConfigProperty:"Invalid config property: {property}",failedToPreLoadElement:" Failed to pre-load HA element: {element}"},Mt={common:Nt,card:zt,editor:Ut,error:Pt},Ot=Object.freeze({__proto__:null,card:zt,common:Nt,default:Mt,editor:Ut,error:Pt});const Dt={[tt.EN]:Ot,[tt.EN_GB]:Ot};function Ft(e=it){const t=(e||"").replace(/['"]+/g,"").replace("-","_").toLowerCase();return console.assert(Object.values(tt).includes(t),`Invalid language: ${t}`),function(e,i={}){let r;try{r=e.split(".").reduce(((e,t)=>e[t]),Dt[t])}catch(t){r=e.split(".").reduce(((e,t)=>e[t]),Dt[it])}void 0===r&&(r=e.split(".").reduce(((e,t)=>e[t]),Dt[it]));for(const[e,t]of Object.entries(i))r=r.replace(`{${e}}`,t);return r}}const Lt=w`
  .item-container {
    display: flex;
    flex-wrap: wrap;
...
`;const Gt=w``,It=w`
  ...
  ${Gt}
`;let Ht=class extends be{constructor(){super(...arguments),this._config={...et},this._cardEntities={},this._dayMode=!0,this._darkMode=!1,this._weatherClass="",this.language=it,this.localize=Ft(this.language),this._initialized=!1}static get styles(){const e=new URL("img/backgrounds",import.meta.url).toString();return w`
      ${Rt}
      ${It}
      ${Lt}
      ...
      ha-card {
        ...
        --background-url: url(${b(`${e}/partially-cloudy.png`)});
        ...
        &.stormy,
        &.dark-mode.stormy {
          --background-url: url(${b(`${e}/stormy.png`)});
    ...
    `}static getStubConfig(){return{...et}}setConfig(e){if(!e)throw new Error(this.localize("error.invalidConfigProperty"));this._config={...this._config,...e}}async _calculateCardEntities(){this._cardEntities=await Et(this.hass,this._config),o.debug("Card Entities Recalculated:",this._cardEntities)}async _calculateWeatherClass(){const e=At(this.hass,this._cardEntities[Ae]);this._weatherClass=wt[e]||"",o.debug("Weather class recalculated:",this._weatherClass)}_unsubscribeForecastEvents(){this._dailyForecastSubscribed&&(this._dailyForecastSubscribed.then((e=>e())).catch((()=>{})),this._dailyForecastSubscribed=void 0)}async _subscribeForecastEvents(){if(this._unsubscribeForecastEvents(),!(this.isConnected&&this._initialized&&this.hass&&this._config))return;const e=this._cardEntities[Ae]?.entity_id;var t,i,r,s;(o.debug("_subscribeForecastEvents()",{forecastEntityId:e}),e)?this._dailyForecastSubscribed=(t=this.hass,i=e,r="daily",s=e=>{o.debug("Daily Forecast Subscribed.",e),this._dailyForecastEvent=e},t.connection.subscribeMessage(s,{type:"weather/subscribe_forecast",forecast_type:r,entity_id:i})):o.warn("⚠️ No Forecast Entity specified. Skipping subscription to daily forecast.")}firstUpdated(){const e=[this._calculateCardEntities,this._calculateWeatherClass];Promise.all(e.map((e=>e.bind(this)()))).finally((()=>{this._initialized=!0}))}updated(e){var t;super.updated(e),o.debug("updated():",e),this._dailyForecastSubscribed&&!e.has("_config")||this._subscribeForecastEvents(),e.has("_config")&&(o.debug("config changed",this._config),this._calculateCardEntities()),e.has("_dailyForecastEvent")&&o.debug("_dailyForecastEvent changed",this._dailyForecastEvent),e.has("_cardEntities")&&this._calculateWeatherClass(),e.has("hass")&&(this._dayMode=(t=this.hass,!t?.states["sun.sun"]||"above_horizon"===t.states["sun.sun"].state),this._darkMode=!0===this.hass.themes.darkMode,this.hass.locale?.language!==this.language&&(this.language=this.hass.locale?.language,this.localize=Ft(this.language)))}connectedCallback(){o.debug("✅ connected to DOM"),super.connectedCallback(),this.hasUpdated&&this._config&&this.hass&&this._subscribeForecastEvents()}disconnectedCallback(){o.debug("❌ disconnected from DOM"),super.disconnectedCallback(),this._unsubscribeForecastEvents()}_renderSummary(){const e=Tt(this._config,this._cardEntities,Te,Ne),t=Tt(this._config,this._cardEntities,Pe,Me),i=Tt(this._config,this._cardEntities,De,Fe),r=Tt(this._config,this._cardEntities,Le,Re),s=Tt(this._config,this._cardEntities,ze,Ue),a=!0===this._config[Ge],n=Tt(this._config,this._cardEntities,Ge,Ie),o=Tt(this._config,this._cardEntities,Ge,We),l=Tt(this._config,this._cardEntities,je,Ve)&&(!this._config[qe]||(St(this.hass,this._cardEntities[Ve])??0)>0),d=Tt(this._config,this._cardEntities,Ze,Je),c=At(this.hass,this._cardEntities[Je]),h=Tt(this._config,this._cardEntities,Ke,Ye);return ie`<div class="summary">
      ...
      ${e||t||i?ie`<div class="item-container reverse">
            ...
            ${e?ie`<bwc-temperature-element
                  ...
                  .isLarge=${!0}
                  .value=${St(this.hass,this._cardEntities[Ne])}
                  .feelsLikeTemperature=${s?St(this.hass,this._cardEntities[Ue]):void 0}
            ...
            ${t?ie`<bwc-weather-icon-element
                  ...
                  .weatherIcon=${At(this.hass,this._cardEntities[Me])}
            ...
            ${i?ie`<bwc-time-date-element
                  ...
                  .cardDateEntity=${this._cardEntities[Re]}
      ...
      ${a||l?ie`<div class="item-container justify-left">
            ${n?ie`<bwc-temperature-element
                  ...
                  .decimalPlaces=${0}
                  .value=${St(this.hass,this._cardEntities[Ie])}
                  .label=${At(this.hass,this._cardEntities[He])}
                ></bwc-temperature-element> `:se}
            ${o?ie`<bwc-temperature-element
                  class="item left no-grow"
                  .decimalPlaces=${0}
                  .value=${St(this.hass,this._cardEntities[We])}
                  .label=${At(this.hass,this._cardEntities[Be])}
                ></bwc-temperature-element> `:se}
            ${l?ie`<bwc-warnings-icon-element
                  class="item right"
                  .value=${St(this.hass,this._cardEntities[Ve])}
      ...
      <div class="item-container column">
        ${d?ie`<bwc-value-label-element
              class="item"
              .value=${`${"0"===c?this.localize("card.noRain"):`${c}mm`}`}
              .label=${"0"===c?void 0:this.localize("card.rain")}
            ></bwc-value-label-element> `:se}
        ${h?ie`<bwc-value-label-element
              class="item"
              .value=${At(this.hass,this._cardEntities[Ye])}
            ></bwc-value-label-element>`:se}
      </div>
    </div> `}render(){return o.debug("🖼️ Rendering card with state:",{weatherClass:this._weatherClass,hass:this.hass,config:this._config,forecast:this._dailyForecastEvent}),ie`<ha-card
      class="${u({day:this._dayMode,night:!this._dayMode,"dark-mode":this._darkMode,"light-mode":!this._darkMode,[this._weatherClass]:!0})}"
    >
      <!-- Card Header -->
    ...
    </ha-card> `}static async getConfigElement(){return await Promise.resolve().then((function(){return li})),document.createElement("bom-weather-card-editor")}};d([xe({attribute:!1})],Ht.prototype,"hass",void 0),d([Ee()],Ht.prototype,"_config",void 0),d([Ee()],Ht.prototype,"_cardEntities",void 0),d([Ee()],Ht.prototype,"_dayMode",void 0),d([Ee()],Ht.prototype,"_darkMode",void 0),d([Ee()],Ht.prototype,"_weatherClass",void 0),d([Ee()],Ht.prototype,"_weatherSummaryData",void 0),d([Ee()],Ht.prototype,"_dailyForecastSubscribed",void 0),d([Ee()],Ht.prototype,"_dailyForecastEvent",void 0),Ht=d([_e("bom-weather-card")],Ht);const Wt=w`
  ${It}

  :host {
    display: block;
  }
`;let Bt=class extends be{constructor(){super(...arguments),this.isLarge=!1,this.decimalPlaces=1}render(){return ie`<div
    ...
    `}};d([xe({type:Boolean})],Bt.prototype,"isLarge",void 0),d([xe({type:Number})],Bt.prototype,"value",void 0),d([xe({type:Number})],Bt.prototype,"feelsLikeTemperature",void 0),d([xe({type:Number})],Bt.prototype,"decimalPlaces",void 0),d([xe()],Bt.prototype,"label",void 0),d([xe()],Bt.prototype,"localize",void 0),Bt=d([_e("bwc-temperature-element")],Bt);let jt=class extends be{constructor(){super(...arguments),this.showDate=!1}_update(){this.hass&&(this._currentTime=At(this.hass,this.cardTimeEntity),this._currentDate=At(this.hass,this.cardDateEntity))}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval((()=>{this._update()}),1e3),this._update()}disconnectedCallback(){super.disconnectedCallback(),this._interval&&clearInterval(this._interval)}render(){const e=this.showDate&&this._currentDate;return ie`<div class=${u("time-date-element")}>
    ...
    `}};d([xe({attribute:!1})],jt.prototype,"hass",void 0),d([xe({type:Boolean})],jt.prototype,"showDate",void 0),d([xe({type:Object})],jt.prototype,"cardTimeEntity",void 0),d([xe({type:Object})],jt.prototype,"cardDateEntity",void 0),d([Ee()],jt.prototype,"_currentTime",void 0),d([Ee()],jt.prototype,"_currentDate",void 0),jt=d([_e("bwc-time-date-element")],jt);let Vt=class extends be{render(){return ie`<div class=${u("value-label-element")}>
    ...
    `}};d([xe()],Vt.prototype,"value",void 0),d([xe()],Vt.prototype,"label",void 0),Vt=d([_e("bwc-value-label-element")],Vt);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const qt=2;class Zt{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Jt extends Zt{constructor(e){if(super(e),this.it=se,e.type!==qt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===se||null==e)return this._t=void 0,this.it=e;if(e===re)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Jt.directiveName="unsafeHTML",Jt.resultType=1;const Kt=(e=>(...t)=>({_$litDirective$:e,values:t}))(Jt);const Yt='<?xml version="1.0" encoding="UTF-8"?>\n<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512"><path d="M23.64,18.1L14.24,2.28c-.47-.8-1.3-1.28-2.24-1.28s-1.77,.48-2.23,1.28L.36,18.1h0c-.47,.82-.47,1.79,0,2.6s1.31,1.3,2.24,1.3H21.41c.94,0,1.78-.49,2.24-1.3s.46-1.78-.01-2.6Zm-10.64-.1h-2v-2h2v2Zm0-4h-2v-6h2v6Z"/></svg>';let Xt=class extends be{render(){return ie`<div
      class=${u("warnings-icon-element",{"has-warnings":this.value&&this.value>0})}
    >
      <div class="icon-value-wrapper">
        <div class="bwc-icon">${ie`${Kt(Yt)}`}</div>
    ...
    `}};d([xe({type:Number})],Xt.prototype,"value",void 0),Xt=d([_e("bwc-warnings-icon-element")],Xt);const Qt=["weather.","forecast","humidity","temperature","temp","wind","precipitation","rain","snow","storm","cloud","uv","sun","dew","barometer","pressure","visibility","air_quality","weather"];let ei=class extends be{constructor(){super(...arguments),this.label="Select a Weather Device",this.value="",this.boobs="",this._initialized=!1,this.weatherDevices=[]}firstUpdated(){this._fetchWeatherDevices(),this._initialized=!0}updated(e){e.has("hass")&&this._fetchWeatherDevices()}_handleOpenedChanged(e){e.detail.value&&this._fetchWeatherDevices()}async _fetchWeatherDevices(){if(this.hass)try{this.weatherDevices=await async function(e){let t=[],i=[];const r=new Set;try{t=await kt(e),i=await xt(e);const s=i.filter((e=>e.device_id&&e.device_id.length>0&&Qt.some((t=>e.entity_id.includes(t)))));return s.forEach((e=>{e.device_id&&r.add(e.device_id)})),t.filter((e=>r.has(e.id)))}catch(e){throw o.error("Error fetching weather-related devices",e),e}}(this.hass)}catch(e){o.error("Error fetching weather-related devices",e)}}_handleValueChanged(e){this._initialized&&(this.value=e.detail.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0})))}render(){return ie`
      <ha-combo-box
    ...
    `}};d([xe({type:String})],ii.prototype,"weatherIcon",void 0),d([xe({type:Boolean})],ii.prototype,"useHAWeatherIcons",void 0),ii=d([_e("bwc-weather-icon-element")],ii);const ri=Ft();o.setLevel("warn"),window.bomWeatherCardLog=o,console.info(`%c  BOM-WEATHER-CARD \n%c  ${ri("common.version")} ${l}    `,"color: fuchsia; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"bom-weather-card",name:ri("common.title"),description:ri("common.description"),documentationURL:"https://github.com/dJPoida/ha-bom-weather-card",preview:!0});const si=Object.freeze({ALERT:"alert",ASSIST_SATELLITE:"assist_satellite",AUTOMATION:"automation",BINARY_SENSOR:"binary_sensor",BUTTON:"button",CALENDAR:"calendar",CAMERA:"camera",CLIMATE:"climate",CONFIGURATOR:"configurator",CONVERSATION:"conversation",COVER:"cover",DATE:"date",DATETIME:"datetime",DEVICE_TRACKER:"device_tracker",EVENT:"event",FAN:"fan",GROUP:"group",HUMIDIFIER:"humidifier",IMAGE:"image",INPUT_BOOLEAN:"input_boolean",INPUT_BUTTON:"input_button",INPUT_DATETIME:"input_datetime",INPUT_NUMBER:"input_number",INPUT_SELECT:"input_select",INPUT_TEXT:"input_text",LAWN_MOWER:"lawn_mower",LIGHT:"light",LOCK:"lock",MEDIA_PLAYER:"media_player",NUMBER:"number",SCENE:"scene",SCRIPT:"script",SELECT:"select",SENSOR:"sensor",STT:"stt",SWITCH:"switch",TEXT:"text",TIME:"time",TIMER:"timer",TTS:"tts",UPDATE:"update",VACUUM:"vacuum",VALVE:"valve",WATER_HEATER:"water_heater",WEATHER:"weather"});si.WEATHER,si.SENSOR;const ai={[Ne]:Te,[ze]:Te,[Ue]:ze,[Me]:Pe,[Oe]:Pe,[Fe]:De,[Le]:Re,[Re]:Le,[Ie]:Ge,[He]:Ge,[We]:Ge,[Be]:Ge,[Ve]:je,[qe]:je,[Je]:Ze,[Ye]:Ke},ni=e=>({entityId:e?.entity_id,attribute:e?.is_inferred?e?.attribute:void 0,displayName:e?.is_inferred?`💡${e?.entity_id??""}${e?.attribute?`[${e?.attribute}]`:""}`:"",isInferred:e?.is_inferred??!1});let oi=class extends be{constructor(){super(...arguments),this._config={...et},this._cardEntities={},this.language=it,this.localize=Ft(this.language),this._initialized=!1}static get styles(){return w`
      ${Rt}
    ...
    >
      <div class="item-group">
        ...
        ${this._config[Te]?ie`<div class="item-group level-one">
              <!-- Current Temp Entity -->
              ${this.renderEntityPicker(Ne,this.localize("editor.currentTemperatureEntity"),[],!1,ni(this._cardEntities[Ne]).displayName)}
        ...
        ${this._config[Pe]?ie`<div class="item-group level-one">
              ${this.renderEntityPicker(Me,this.localize("editor.weatherIconEntity"),[],!1,ni(this._cardEntities[Me]).displayName)}
        ...
        ${this._config[De]?ie`<div class="item-group level-one">
              ${this.renderEntityPicker(Fe,this.localize("editor.timeEntity"),[],!1,ni(this._cardEntities[Fe]).displayName)}

              <!-- Show Date -->
              ${this.renderBooleanField(Le,this.localize("editor.showDate"))}

              <!-- Date Entity -->
              ${this._config[Le]?this.renderEntityPicker(Re,this.localize("editor.dateEntity"),[],!1,ni(this._cardEntities[Re]).displayName):se}
            </div>`:se}

        <!-- Show Now / Later Temps -->
        ${this.renderBooleanField(Ge,this.localize("editor.showNowLaterTemps"))}
        ${this._config[Ge]?ie`<div class="item-group level-one">
              <!-- Now Temp Entity -->
              ${this._config[Ge]?this.renderEntityPicker(Ie,this.localize("editor.nowTempEntity"),[],!1,ni(this._cardEntities[Ie]).displayName):se}

              <!-- Now Label Entity -->
              ${this._config[Ge]?this.renderEntityPicker(He,this.localize("editor.nowLabelEntity"),[],!1,ni(this._cardEntities[He]).displayName):se}

              <!-- Later Temp Entity -->
              ${this._config[Ge]?this.renderEntityPicker(We,this.localize("editor.laterTempEntity"),[],!1,ni(this._cardEntities[We]).displayName):se}

              <!-- Later Label Entity -->
              ${this._config[Ge]?this.renderEntityPicker(Be,this.localize("editor.laterLabelEntity"),[],!1,ni(this._cardEntities[Be]).displayName):se}
            </div>`:se}
    ...
    </ha-expansion-panel>`}render(){if(!this._config||!this._initialized)return ie``;const e=ni(this._cardEntities[Ae]);return ie`<div class="card-config">
      <div class="item-group">
        <!-- Title -->
        ...
        <!-- Forecast Entity ID -->
        ${this.renderEntityPicker(Ae,this.localize("editor.summaryWeatherEntity"),[si.WEATHER],!1,e.displayName)}
      </div>
    ...
    </div> `}};d([xe({attribute:!1})],oi.prototype,"hass",void 0),d([Ee()],oi.prototype,"_config",void 0),d([Ee()],oi.prototype,"_cardEntities",void 0),oi=d([_e("bom-weather-card-editor")],oi);var li=Object.freeze({__proto__:null,get BomWeatherCardEditor(){return oi}});
