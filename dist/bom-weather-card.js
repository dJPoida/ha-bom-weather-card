...
`;const Bt=y``,Wt=y`
  ...
  ${Bt}
`;let jt=class extends fe{constructor(){super(...arguments),this._config={...lt},this._cardEntities={},this._dayMode=!0,this._darkMode=!1,this._weatherClass="",this.language=nt,this.localize=Vt(this.language),this._initialized=!1}static get styles(){return y`
      ${Rt}
      ${Wt}
      ${Ut}
    ...
    `}render(){if(!this._forecastEvent||!this._forecastEvent.forecast)return X`
        <div class="container">
          ${this.showTitle?X`<div class="title">Daily forecast</div>`:ee}
          <div class="loading">Loading Forecast...</div>
        </div>
      `;const e=new Date;e.setHours(0,0,0,0);const t=this._forecastEvent.forecast.filter((t=>{const s=new Date(t.datetime);return s.setHours(0,0,0,0),s.getTime()!==e.getTime()})).map((e=>this._renderForecastRow(new Date(e.datetime).toLocaleDateString("en-US",{weekday:"long"}),e.templow??void 0,e.temperature,e.precipitation??0,e.precipitation_probability??0,e.condition??"")));return X`
      <div class="container">
        ${this.showTitle?X`<div class="title">Daily forecast</div>`:ee}
        <div class="forecast-grid">
          ${t.length>0?t:X`<div class="loading">No future forecast available.</div>`}
        </div>
      </div>
    `}};Jt.styles=y`
    :host {
  ...
  `,o([be({attribute:!1})],Jt.prototype,"hass",void 0),o([be({type:String})],Jt.prototype,"forecastEntityId",void 0),o([be({type:Boolean})],Jt.prototype,"useHAWeatherIcons",void 0),o([be({type:Boolean})],Jt.prototype,"showTitle",void 0),o([_e()],Jt.prototype,"_forecastSubscribed",void 0),o([_e()],Jt.prototype,"_forecastEvent",void 0),Jt=o([ve("bwc-daily-forecast-element")],Jt);var Kt,Yt={exports:{}};
/*!
...
*/var Xt=(Kt||(Kt=1,function(e){!function(){var t={}.hasOwnProperty;function s(){for(var e="",t=0;t<arguments.length;t++){var s=arguments[t];s&&(e=a(e,i(s)))}return e}function i(e){if("string"==typeof e||"number"==typeof e)return e;if("object"!=typeof e)return"";if(Array.isArray(e))return s.apply(null,e);if(e.toString!==Object.prototype.toString&&!e.toString.toString().includes("[native code]"))return e.toString();var i="";for(var c in e)t.call(e,c)&&e[c]&&(i=a(i,c));return i}function a(e,t){return t?e?e+" "+t:e+t:e}e.exports?(s.default=s,e.exports=s):window.classNames=s}()}(Yt)),Yt.exports),Qt=e(Xt);const es=(e,t)=>{const s=Zt(e,t);if(void 0!==s){if("number"==typeof s)return s;if("string"==typeof s)try{return parseFloat(s)}catch{return}}},ts=(e,t,s,i)=>{const a=Array.isArray(s)?s:[s];for(const t of a)if(!e[t])return!1;return!!t[i]?.entity_id};let ss=class extends fe{static get styles(){const e=new URL("img/backgrounds",import.meta.url).toString();return y`
    ...
    `}render(){const e=ts(this.config,this.cardEntities,ze,Ie),t=ts(this.config,this.cardEntities,Fe,De),s=t?zt(this.hass,this.cardEntities[De]):"",i=ts(this.config,this.cardEntities,Ne,Ve),a=ts(this.config,this.cardEntities,Ue,Re),c=ts(this.config,this.cardEntities,Oe,Pe),l=!0===this.config[Be],r=ts(this.config,this.cardEntities,Be,We),n=ts(this.config,this.cardEntities,Be,qe),o=ts(this.config,this.cardEntities,Je,Ke)&&(!this.config[Ye]||(es(this.hass,this.cardEntities[Ke])??0)>0),d=ts(this.config,this.cardEntities,Xe,Qe),h=zt(this.hass,this.cardEntities[Qe]),p=ts(this.config,this.cardEntities,et,tt);return X`<div
    ...
    >
      ...
      ${e||t||i?X`<div class="item-container reverse">
            ...
            ${e?X`<bwc-temperature-element
                  ...
                  .localize=${this.localize}
                  .isLarge=${!0}
                  .value=${es(this.hass,this.cardEntities[Ie])}
            ...
            ${i?X`<bwc-time-date-element
                  ...
                  .cardDateEntity=${this.cardEntities[Re]}
    ...
    `}renderSummaryOptionsPanel(){return X`<ha-expansion-panel .outlined=${!0} header="${this.localize("editor.summary")}">
      <div class="item-group">
        ...
        ${this._config[ze]?X`<div class="item-group level-one">
              <!-- Current Temp Entity -->
              ${this.renderEntityPicker(Ie,this.localize("editor.currentTemperatureEntity"),[],!1,Hs(this._cardEntities[Ie]).displayName)}

              <!-- Show Feels Like Temperature -->
              ${this._config[ze]?this.renderBooleanField(Oe,this.localize("editor.showFeelsLikeTemperature")):ee}

              <!-- Feels Like Temp Entity -->
              ${this._config[ze]&&this._config[Oe]?this.renderEntityPicker(Pe,this.localize("editor.feelsLikeTemperatureEntity"),[],!1,this._cardEntities[Pe]?.is_inferred?this._cardEntities[Pe].entity_id:void 0):ee}
            </div> `:ee}
        ...
        ${this._config[Ne]?X`<div class="item-group level-one">
              ...
              <!-- Show Date -->
              ${this.renderBooleanField(Ue,this.localize("editor.showDate"))}

              <!-- Date Entity -->
              ${this._config[Ue]?this.renderEntityPicker(Re,this.localize("editor.dateEntity"),[],!1,Hs(this._cardEntities[Re]).displayName):ee}
            </div>`:ee}
