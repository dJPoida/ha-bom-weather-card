...
let WeatherIconElement = class WeatherIconElement extends r$2 {
    ...
    render() {
        if (!this.weatherIcon)
            return E;
        return x `<div class=${classNames('weather-icon-element', this.iconSize, this.weatherIcon)}>
